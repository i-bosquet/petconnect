...
INSERT INTO clinic (id, name, address, city, country, phone, public_key, created_at, created_by) VALUES
    (1, 'The London Vet Clinic', '123 Regent Street', 'London', 'United Kingdom', '+44 20 1234 5678', 'LON_PUB_KEY_123', NOW(), 'system')
ON CONFLICT (id) DO NOTHING; -- Use ON CONFLICT (id) now
...
INSERT INTO clinic_staff (user_id, name, surname, is_active, clinic_id) VALUES
    (2, 'John', 'Smith', true, 1) -- User ID 2, Clinic ID 1
ON CONFLICT (user_id) DO NOTHING;

-- Clinic 2 (ID=3) & Admin 2 (ID=4)
INSERT INTO clinic (id, name, address, city, country, phone, public_key, created_at, created_by) VALUES
    (3, 'Manchester Pet Hospital', '45 Market Street', 'Manchester', 'United Kingdom', '+44 161 987 6543', 'MAN_PUB_KEY_456', NOW(), 'system')
ON CONFLICT (id) DO NOTHING;
INSERT INTO users (id, username, email, password, avatar, is_enabled, account_non_expired, account_non_locked, credentials_non_expired, created_at, created_by) VALUES
...
-- CAT Breeds
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Angora', 'CAT', 'images/avatars/pets/cat_angora.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Black', 'CAT', 'images/avatars/pets/cat_black.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Bombay', 'CAT', 'images/avatars/pets/cat_bombay.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Common European', 'CAT', 'images/avatars/pets/cat_common_european.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Himalayan', 'CAT', 'images/avatars/pets/cat_himalayan.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Norwegian Forest', 'CAT', 'images/avatars/pets/cat_norwegian_forest.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Persian', 'CAT', 'images/avatars/pets/cat_persian.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Ragdoll', 'CAT', 'images/avatars/pets/cat_ragdoll.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Russian Blue', 'CAT', 'images/avatars/pets/cat_russian_blue.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Siamese', 'CAT', 'images/avatars/pets/cat_siamese.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Siberian', 'CAT', 'images/avatars/pets/cat_siberian.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Tabby', 'CAT', 'images/avatars/pets/cat_tabby.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'White', 'CAT', 'images/avatars/pets/cat_write.png') ON CONFLICT (name, specie) DO NOTHING;

-- DOG Breeds
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Argentine Dogo', 'DOG', 'images/avatars/pets/dog_argentine_dogo.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Beagle', 'DOG', 'images/avatars/pets/dog_beagle.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Boxer', 'DOG', 'images/avatars/pets/dog_boxer.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Bulldog', 'DOG', 'images/avatars/pets/dog_bulldog.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Chihuahua', 'DOG', 'images/avatars/pets/dog_chihuahua.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Dachshund', 'DOG', 'images/avatars/pets/dog_dachshund.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Dalmatian', 'DOG', 'images/avatars/pets/dog_dalmatian.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Doberman', 'DOG', 'images/avatars/pets/dog_doberman.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'French Bulldog', 'DOG', 'images/avatars/pets/dog_french_bulldog.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'German Shepherd', 'DOG', 'images/avatars/pets/dog_german_shepherd.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Golden', 'DOG', 'images/avatars/pets/dog_golden.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Golden Retriever', 'DOG', 'images/avatars/pets/dog_golden_retriever.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Great Dane', 'DOG', 'images/avatars/pets/dog_great_dane.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Labrador Retriever', 'DOG', 'images/avatars/pets/dog_labrador_retriever.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Pekingese', 'DOG', 'images/avatars/pets/dog_pekingese.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Pincher', 'DOG', 'images/avatars/pets/dog_pincher.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Poodle', 'DOG', 'images/avatars/pets/dog_poodle.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Pug', 'DOG', 'images/avatars/pets/dog_pug.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Rottweiler', 'DOG', 'images/avatars/pets/dog_rottweiler.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Saint Bernard', 'DOG', 'images/avatars/pets/dog_saint_bernard.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Shih Tzu', 'DOG', 'images/avatars/pets/dog_shih_tzu.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Siberian Husky', 'DOG', 'images/avatars/pets/dog_siberian_husky.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Yorkshire Terrier', 'DOG', 'images/avatars/pets/dog_yorkshire_terrier.png') ON CONFLICT (name, specie) DO NOTHING;

-- FERRET Breeds/Types
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Cinnamon', 'FERRET', 'images/avatars/pets/ferret_cinnamon.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Sable Mask', 'FERRET', 'images/avatars/pets/ferret_sable_mask.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Siamese', 'FERRET', 'images/avatars/pets/ferret_siamese.png') ON CONFLICT (name, specie) DO NOTHING;

-- RABBIT Breeds/Types
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Brown', 'RABBIT', 'images/avatars/pets/rabbit_brown.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Grey', 'RABBIT', 'images/avatars/pets/rabbit_grey.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Lop', 'RABBIT', 'images/avatars/pets/rabbit_lop.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'White', 'RABBIT', 'images/avatars/pets/rabbit_white.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Black', 'RABBIT', 'images/avatars/pets/rabbit_blak.png') ON CONFLICT (name, specie) DO NOTHING;

-- Generic 'Breed' entries
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Mixed/Other', 'CAT', 'images/avatars/pets/cat.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Mixed/Other', 'DOG', 'images/avatars/pets/dog.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Standard/Other', 'FERRET', 'images/avatars/pets/ferret.png') ON CONFLICT (name, specie) DO NOTHING; -- Cambiado a Standard/Other
INSERT INTO breed (id, name, specie, image_url) VALUES (nextval('breed_id_sequence'), 'Mixed/Other', 'RABBIT', 'images/avatars/pets/rabbit.png') ON CONFLICT (name, specie) DO NOTHING;
