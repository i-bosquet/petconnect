...
-- CAT Breeds
INSERT INTO breed (name, specie, image_url) VALUES ('Angora', 'CAT', 'images/avatars/pets/cat_angora.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Black', 'CAT', 'images/avatars/pets/cat_black.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Bombay', 'CAT', 'images/avatars/pets/cat_bombay.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Common European', 'CAT', 'images/avatars/pets/cat_common_european.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Himalayan', 'CAT', 'images/avatars/pets/cat_himalayan.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Norwegian Forest', 'CAT', 'images/avatars/pets/cat_norwegian_forest.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Persian', 'CAT', 'images/avatars/pets/cat_persian.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Ragdoll', 'CAT', 'images/avatars/pets/cat_ragdoll.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Russian Blue', 'CAT', 'images/avatars/pets/cat_russian_blue.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Siamese', 'CAT', 'images/avatars/pets/cat_siamese.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Siberian', 'CAT', 'images/avatars/pets/cat_siberian.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Tabby', 'CAT', 'images/avatars/pets/cat_tabby.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('White', 'CAT', 'images/avatars/pets/cat_write.png') ON CONFLICT (name, specie) DO NOTHING;

-- DOG Breeds
INSERT INTO breed (name, specie, image_url) VALUES ('Argentine Dogo', 'DOG', 'images/avatars/pets/dog_argentine_dogo.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Beagle', 'DOG', 'images/avatars/pets/dog_beagle.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Boxer', 'DOG', 'images/avatars/pets/dog_boxer.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Bulldog', 'DOG', 'images/avatars/pets/dog_bulldog.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Chihuahua', 'DOG', 'images/avatars/pets/dog_chihuahua.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Dachshund', 'DOG', 'images/avatars/pets/dog_dachshund.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Dalmatian', 'DOG', 'images/avatars/pets/dog_dalmatian.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Doberman', 'DOG', 'images/avatars/pets/dog_doberman.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('French Bulldog', 'DOG', 'images/avatars/pets/dog_french_bulldog.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('German Shepherd', 'DOG', 'images/avatars/pets/dog_german_shepherd.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Golden', 'DOG', 'images/avatars/pets/dog_golden.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Golden Retriever', 'DOG', 'images/avatars/pets/dog_golden_retriever.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Great Dane', 'DOG', 'images/avatars/pets/dog_great_dane.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Labrador Retriever', 'DOG', 'images/avatars/pets/dog_labrador_retriever.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Pekingese', 'DOG', 'images/avatars/pets/dog_pekingese.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Pincher', 'DOG', 'images/avatars/pets/dog_pincher.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Poodle', 'DOG', 'images/avatars/pets/dog_poodle.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Pug', 'DOG', 'images/avatars/pets/dog_pug.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Rottweiler', 'DOG', 'images/avatars/pets/dog_rottweiler.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Saint Bernard', 'DOG', 'images/avatars/pets/dog_saint_bernard.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Shih Tzu', 'DOG', 'images/avatars/pets/dog_shih_tzu.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Siberian Husky', 'DOG', 'images/avatars/pets/dog_siberian_husky.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Yorkshire Terrier', 'DOG', 'images/avatars/pets/dog_yorkshire_terrier.png') ON CONFLICT (name, specie) DO NOTHING;

-- FERRET Breeds/Types
INSERT INTO breed (name, specie, image_url) VALUES ('Cinnamon', 'FERRET', 'images/avatars/pets/ferret_cinnamon.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Sable Mask', 'FERRET', 'images/avatars/pets/ferret_sable_mask.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Siamese', 'FERRET', 'images/avatars/pets/ferret_siamese.png') ON CONFLICT (name, specie) DO NOTHING;

-- RABBIT Breeds/Types
INSERT INTO breed (name, specie, image_url) VALUES ('Brown', 'RABBIT', 'images/avatars/pets/rabbit_brown.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Grey', 'RABBIT', 'images/avatars/pets/rabbit_grey.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Lop', 'RABBIT', 'images/avatars/pets/rabbit_lop.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('White', 'RABBIT', 'images/avatars/pets/rabbit_white.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Black', 'RABBIT', 'images/avatars/pets/rabbit_blak.png') ON CONFLICT (name, specie) DO NOTHING;

-- Generic 'Breed' entries
INSERT INTO breed (name, specie, image_url) VALUES ('Mixed/Other', 'CAT', 'images/avatars/pets/cat.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Mixed/Other', 'DOG', 'images/avatars/pets/dog.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Standard/Other', 'FERRET', 'images/avatars/pets/ferret.png') ON CONFLICT (name, specie) DO NOTHING;
INSERT INTO breed (name, specie, image_url) VALUES ('Mixed/Other', 'RABBIT', 'images/avatars/pets/rabbit.png') ON CONFLICT (name, specie) DO NOTHING;

-- =============================================
-- UPDATE SEQUENCES (Adjust sequence names if different)
-- =============================================
-- Update sequence for 'breed' table after inserts
SELECT setval('breed_id_sequence', COALESCE((SELECT MAX(id) FROM breed), 1), false);
-- Update sequence for tables using 'entity_id_sequence' (users, clinic, pet, etc.) after all relevant inserts
-- Find the overall maximum ID used across tables sharing this sequence
SELECT setval('entity_id_sequence', COALESCE(GREATEST(
                                                     (SELECT MAX(id) FROM users),
                                                     (SELECT MAX(id) FROM clinic)
                                                 -- Add other tables using entity_id_sequence if applicable (e.g., Pet)
                                             ), 1), false);

-- Note: setval(sequence, value, is_called=false) sets the *next* value returned by nextval() to 'value'.
-- If you use is_called=true, it sets the *current* value, so nextval() returns value + increment.
-- Setting it based on MAX(id) and is_called=false ensures the next generated ID is MAX(id) + 1.
-- Using COALESCE(..., 1) handles the case where a table might be empty, starting the sequence correctly.