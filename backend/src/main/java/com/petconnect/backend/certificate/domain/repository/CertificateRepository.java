...
public interface CertificateRepository extends JpaRepository<Certificate, Long> {
    ...
    /**
     * Finds a certificate by the ID of the medical record it originated from.
     *
     * @param recordId The ID of the originating medical record (make sure the field name matches: medicalRecord.id).
     * @return An Optional containing the {@link Certificate} if found, empty otherwise.
     */
    Optional<Certificate> findByMedicalRecordId(Long recordId); // Corregido para usar el nombre de campo correcto


    /**
     * Finds all certificates issued by a specific veterinarian, ordered by creation date descending.
     *
     * @param vetId The ID of the generating veterinarian (make sure the field name matches: generatorVet.id).
     * @return A list of certificates generated by the specified Vet.
     */
    List<Certificate> findByGeneratorVetIdOrderByCreatedAtDesc(Long vetId);

    /**
     * Finds all certificates issued by a specific clinic, ordered by creation date descending.
     *
     * @param clinicId The ID of the issuing clinic (make sure the field name matches: issuingClinic.id).
     * @return A list of certificates issued by the specified Clinic.
     */
    List<Certificate> findByIssuingClinicIdOrderByCreatedAtDesc(Long clinicId);
