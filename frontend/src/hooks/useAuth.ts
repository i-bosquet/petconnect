        ...
        if (storedUserJson) {
            try {
                ...
                const userForState: StoredUserDataType = {
                    ...
                    roles: Array.isArray(storedUserFromStorage.roles) ? storedUserFromStorage.roles : (typeof storedUserFromStorage.role === 'string' ? [storedUserFromStorage.role] : []),
