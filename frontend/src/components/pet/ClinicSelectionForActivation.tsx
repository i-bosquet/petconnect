...
interface ClinicSelectionForActivationProps {
    isOpen: boolean;
    onClose: () => void;
...
/**
 * ClinicSelectionForActivation - Modal for searching and selecting a clinic
 * specifically for the pet activation request flow.
 * @param {ClinicSelectionForActivationProps} props - Component props.
 * @returns {JSX.Element | null} The modal component or null if not open.
 * @author ibosquet
 */
const ClinicSelectionForActivation = ({ isOpen, onClose, onClinicSelected }: ClinicSelectionForActivationProps): JSX.Element | null => {
    ...
    const fetchClinicsCallback = useCallback(async (page: number, params: { name: string; city: string; country: string }) => {
        ...
        try {
            ...
            let errorMsg = "Failed to load countries list.";
    ...
    }, []); // No dependencies, as it's called with current state
...
export default ClinicSelectionForActivation;